...
import {  faSearch , faShoppingBag, faNavicon, faClose} from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <>
            <div className='flex justify-between items-center px-5 border-b gap-2'>
                ...
                <div className='lg:hidden cursor-pointer' onClick={props.hamburgerMenuHandler} >
